                    ...
                    <td class="col-1">
                        <div class="dashboard">
                            <form action="{{ route('update') }}" method="GET">
                                @csrf
                                <button name="id" type="submit" value="{{ $order->id }}" class="btn btn-outline-primary">
                            ...
                            <form action="{{ route('delete') }}" method="POST">
                                @csrf
                                <button name="id" type="submit" value="{{ $order->id }}" class="btn btn-outline-danger">
